-- original; https://github.com/i77lhm/Libraries/blob/main/ESP/Example.lua
-- ill modify it to make it more fitting
-- edit: ive gone too far deep in now.. not publishing the update
-- https://i.fakecrime.bio/imgs/uxVDg.png
-- i just dont like the font stroke it looks dogshit
...
local fonts = {}; do
    ...
    local ProggyNigga = Register_Font("OPSECProggyNigga!", 100, "Normal", {
        Id = "ProggyNigga.ttf",
        Font = game:HttpGet("https://flohaxx.vercel.app/font/Proggy.ttf"),
    })

    fonts = {
        main = Font.new(ProggyNigga, Enum.FontWeight.Regular, Enum.FontStyle.Normal);
    }
end
            ...
            local objects = data.objects; do
                ...
                -- Healthbar
                    objects[ "healthbar_holder" ] = esp:create( "Frame" , {
                        ...
                        BorderColor3 = rgb(0, 0, 0);
                        Size = dim2(0, (flags["Healthbar_Width"] or 2), 1, 2);
                        BorderSizePixel = 0;
                        BackgroundColor3 = rgb(0, 0, 0)
                    });
