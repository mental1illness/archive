...
do
    ...
    local themes = {
    preset = {
        ["outline"] = rgb(15, 15, 18),        -- darker border
        ["inline"] = rgb(25, 25, 35),         -- inner panels
        ["accent"] = rgb(120, 100, 150),      -- muted accent
        ["high_contrast"] = rgb(20, 20, 30),  -- elements that need to pop
        ["low_contrast"] = rgb(18, 18, 28),   -- subtle background bits
        ["text"] = rgb(200, 200, 200),        -- readable light text
        ["text_outline"] = rgb(10, 10, 10),   -- soft outline
        ["glow"] = rgb(120, 100, 150),        -- matching accent glow
    },
    ...
    writefile(library.directory .. "/fonts/main.ttf", game:HttpGet("https://github.com/inveris1337/storage/raw/refs/heads/main/fonts/ProggyClean.ttf"))
